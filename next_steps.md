...
--   'available', 'scheduled', 'in_transit', 'installed', 'defect', 'in_repair'
--   (changed: 'reserved' is now 'scheduled', added 'in_repair')
...
### 8. Movement Type Badges (Priority: LOW)

Update the MovementBadge component to include the new `return` type:
- `return` — teal or cyan badge

### 9. Stock-In Update — Warranty + Allocation Fields (Priority: LOW)
